...
import { getDigitalGraphicById, updateDigitalGraphicById } from 'apiSdk/digital-graphics';
...
function DigitalGraphicEditPage() {
  ...
  const handleSubmit = async (values: DigitalGraphicInterface, { resetForm }: FormikHelpers<any>) => {
    setFormError(null);
    try {
      const updated = await updateDigitalGraphicById(id, values);
      mutate(updated);
      resetForm();
